...
<div class="col-xs-12">
	<div class="page-title-box">
        <h4 class="page-title">Update E-Mail</h4>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <form name="settings_form" action="<?php echo base_url('admin/dashboard/updateEmail');?>" method="post" enctype="multipart/form-data">
					...
					<?php } ?>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                   <input type="text" class="form-control" id="type" name="type" value="<?php echo $categories->type; ?>" />
                                </div>
                            </div>
                             <div class="form-group">
                               <label for="admin_email" class="col-sm-2 control-label">Email Title</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="emailTitle" name="emailTitle" value="<?php echo $categories->emailTitle; ?>" />
                                </div>
                            </div>
							<div class="form-group">
                               <label for="admin_email" class="col-sm-2 control-label">Email Description</label>
                                <div class="col-md-10">
                                   <textarea class="ckeditor form-control" id="description" name="description"><?php echo $categories->description; ?></textarea>
