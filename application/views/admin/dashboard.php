...
<html>
    ...
    <body class="fixed-left">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table table-hover m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th>
                                                        <img src="<?php echo DEFAULT_ASSETS_URL;?>images/users/avatar-1.jpg" alt="user" class="thumb-sm img-circle" />
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th>
                                                        <img src="<?php echo DEFAULT_ASSETS_URL;?>images/users/avatar-2.jpg" alt="user" class="thumb-sm img-circle" />
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th>
                                                        <img src="<?php echo DEFAULT_ASSETS_URL;?>images/users/avatar-3.jpg" alt="user" class="thumb-sm img-circle" />
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th>
                                                        <img src="<?php echo DEFAULT_ASSETS_URL;?>images/users/avatar-4.jpg" alt="user" class="thumb-sm img-circle" />
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th>
                                                        <img src="<?php echo DEFAULT_ASSETS_URL;?>images/users/avatar-5.jpg" alt="user" class="thumb-sm img-circle" />
                                                    </th>
                                                    <td>
        ...
        <!-- Counter js  -->
        <script src="<?php echo DEFAULT_ASSETS_URL;?>plugins/waypoints/jquery.waypoints.min.js"></script>
        <script src="<?php echo DEFAULT_ASSETS_URL;?>plugins/counterup/jquery.counterup.min.js"></script>

        <!--Morris Chart-->
        <script src="<?php echo DEFAULT_ASSETS_URL;?>plugins/morris/morris.min.js"></script>
        <script src="<?php echo DEFAULT_ASSETS_URL;?>plugins/raphael/raphael-min.js"></script>

        <!-- Dashboard init -->
        <script src="<?php echo DEFAULT_ASSETS_URL;?>pages/jquery.dashboard.js"></script>
